...
public class ProfileUpdateFragment extends Fragment {
    ...
    private Spinner sp_update_country;
    private ProgressDialog loadingBar;
    private String name, phone, gender, farmName, location, country;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        sp_update_country = view.findViewById(R.id.sp_update_country);
    ...
    private void updateProfile(FirebaseUser currentUser) {
        ...
        if (TextUtils.isEmpty(name)) {
            ...
            country = sp_update_country.getSelectedItem().toString();
            gender = rb_update_gender_selected.getText().toString();

            //update user data in firebase
            ReadWriteUserDetails writeUserDetails = new ReadWriteUserDetails(phone, gender, farmName, location, country);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (readUserDetails != null) {
                    ...
                    if (country.equals("Afghanistan")) {
                        sp_update_country.setSelection(0);
                    } else if (country.equals("Bangladesh")) {
                        sp_update_country.setSelection(1);
                    } else if (country.equals("Bhutan")) {
                        sp_update_country.setSelection(2);
                    } else if (country.equals("India")) {
                        sp_update_country.setSelection(3);
                    } else if (country.equals("Maldives")) {
                        sp_update_country.setSelection(4);
                    } else if (country.equals("Nepal")) {
                        sp_update_country.setSelection(5);
                    } else if (country.equals("Pakistan")) {
                        sp_update_country.setSelection(6);
                    } else if (country.equals("Sri Lanka")) {
                        sp_update_country.setSelection(7);
                    }
