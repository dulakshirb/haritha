...
public class BioGasFragment extends Fragment {
    ...
    private EditText txt_input_wastage;
    private Button btn_addWastage, btn_dialog_no, btn_dialog_yes, btn_resetWastage, btn_dialog_resetNo, btn_dialog_resetYes;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btn_addWastage = view.findViewById(R.id.btn_addWastage);
        btn_resetWastage = view.findViewById(R.id.btn_resetWastage);
        ...
        btn_addWastage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        btn_resetWastage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                resetDialogConfirmation.show();
            }
        });
        btn_dialog_resetNo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                resetDialogConfirmation.dismiss();
            }
        });
        btn_dialog_resetYes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                resetWastage();
                resetDialogConfirmation.dismiss();
        ...
        dbReferenceBioGas.child("wastage").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if ((snapshot.exists()) && (snapshot.hasChild("wastage_amount"))) {
                    current_wastage_amount = Float.parseFloat(snapshot.child("wastage_amount").getValue().toString());

                    //days pass calculate
                    Calendar calendarToday = Calendar.getInstance();
                    long today = calendarToday.getTimeInMillis();
                    long startedDate = Long.parseLong(snapshot.child("started_date").getValue().toString());
